...
package javaeerecipes.jpa.entity;
...
@SqlResultSetMapping(name="authorBooks",
        entities= {
            @EntityResult(entityClass=javaeerecipes.jpa.entity.Book.class, fields={
                @FieldResult(name="id", column="BOOK_ID"),
                @FieldResult(name="title", column="TITLE")
            }),
            @EntityResult(entityClass=javaeerecipes.jpa.entity.BookAuthor.class, fields={
