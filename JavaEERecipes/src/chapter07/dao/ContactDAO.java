...
import chapter07.Contact;
import chapter07.CreateConnection;
...
public class ContactDAO implements java.io.Serializable {
    ...
    public List<Contact> queryContacts() {
        String qry = "select id,  firstname, lastname, email, password, description, "
    ...
    public  Contact performFind(int id){
        String qry = "SELECT ID, FIRSTNAME, LASTNAME, EMAIL, PASSWORD, DESCRIPTION, OCCUPATION, "
